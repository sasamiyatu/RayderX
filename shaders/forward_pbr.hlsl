...
FSOutput fs_main(FSInput input)
{
    ...
    //float opacity = basecolor_texture.SampleBias(anisotropic_sampler, input.uv, -5).a;
    float opacity = basecolor_texture.SampleLevel(anisotropic_sampler, input.uv, 0).a;
